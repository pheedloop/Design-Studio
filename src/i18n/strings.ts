...
export const COMMON = {
  ...
  "gallery.dropHint": "Drag and drop files or select browse.",
  "gallery.empty": "No images available.",
  "gallery.insert": "Insert",
  "gallery.noResults": "No images match your search.",
  "gallery.searchPlaceholder": "Search filename…",
  "gallery.sort": "Sort",
  "gallery.sortName": "Name",
  "gallery.sortRecent": "Recent",
...
export const BADGEEDITOR = {
  "attendee.clear": "Clear",
  "attendee.noResults": "No attendees found",
  ...
  "debug.layoutHeader": 'badge_layout · {{width}}" × {{height}}"',
  "debug.open": "Debug",
  "debug.title": "Debug: View badge_layout JSON",
  "field.addressCity": "City",
  "field.addressCountry": "Country",
  "field.addressState": "State/Province",
  "field.cityState": "City+State/Provinces",
  "field.codeInternal": "Internal Code",
  "field.customText": "Custom Text Field",
  "field.customTextDefault": "Custom Text",
  "field.designations": "Designations",
  "field.dietaryRestrictions": "Dietary Restrictions",
  "field.externalQrCode": "External QR Code",
  ...
  "field.sessionSchedule": "Session Schedule",
  "field.tableNumber": "Table Number",
  "field.tags": "Tags",
  "field.tickets": "Tickets",
  "menu.badgeSetup": "Badge Setup…",
  "menu.copy_one": "Copy",
  "menu.copy_other": "Copy ({{count}})",
  "menu.delete_one": "Delete",
  "menu.delete_other": "Delete ({{count}})",
  "menu.edit": "Edit",
  "menu.exportJson": "Export as JSON",
  "menu.file": "File",
  "menu.paste": "Paste",
  ...
  "page.front": "Front",
  "page.inside": "Inside",
  "page.invertedTab": "{{page}} ⤓",
  "preview.banner": "Full preview · as printed (read-only)",
  "preview.enter": "Full preview",
  "preview.exit": "Exit preview",
  "properties.align": "Align",
  "properties.alignCenter": "Align center",
  "properties.alignJustify": "Justify",
  ...
  "properties.resizeHint": "Drag to move; drag a corner to resize.",
  "properties.rows": "Rows",
  "properties.size": "Size",
  "properties.text": "Text",
  "selection.count_one": "{{count}} field selected",
  "selection.count_other": "{{count}} fields selected",
  ...
  "setup.panelWidth": "Panel width ({{unit}})",
  "setup.panels": "Panels",
  "setup.presetPlaceholder": "Choose a badge type…",
  "setup.presets": "Badge type",
  "setup.printsAs": "Prints as {{width}} × {{height}} {{unit}}",
  ...
  "sidebar.customFields": "Custom Fields",
  "sidebar.image": "Image",
