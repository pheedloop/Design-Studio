...
export const SEATVIEWER = {
  ...
  "assign.cta": "Assign",
  "assign.noneEligible": "None of the selected are eligible for this table.",
  ...
  "assign.selectEligible": "Select eligible ticket holders",
  ...
  "assign.someIneligible_one": "{{count}} of {{total}} selected isn’t eligible for this table.",
  "assign.someIneligible_other": "{{count}} of {{total}} selected aren’t eligible for this table.",
  ...
  "tickets.clear": "Clear",
  "tickets.counts": "{{shown}} shown · {{selected}} selected",
