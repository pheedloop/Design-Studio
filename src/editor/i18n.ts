// Map editor i18n, bound to this surface's English slice. See src/i18n/context.tsx
// for why the binding is per-surface.
...
/** English for every key the map editor can render. Hosts index this by key. */
